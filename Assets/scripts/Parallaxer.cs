   ...
   class PoolObjects
    {
        ...
        public bool inUse;
        public PoolObjects(Transform t) { transform = t; }
    ...
    void Configure()
    {
        ...
        poolObjects = new PoolObjects[poolSize];
        for(int i=0; i<poolObjects.Length; i++)
        {
            ...
            poolObjects[i] = new PoolObjects(t);
        }
        if (spawnImmediate)
        {
            SpawnImmediate();
    ...
    void CheckDisposeObject(PoolObjects poolObject)
    {
